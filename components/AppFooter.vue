<template>
  <footer class="bg-white">
    <div
      class="max-w-screen-xl mx-auto py-6 md:py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8"
    >
      ...
      <div class="flex justify-center items-center mt-4 text-sm md:mt-0">
        <NuxtLink
          no-prefetch
          to="/privacy/"
          class="text-gray-400 hover:text-gray-500 inline-block my-2 lg:my-0"
        >
          Privacy
        </NuxtLink>
