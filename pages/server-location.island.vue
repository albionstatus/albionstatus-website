...
const content: FaqContent[] = [
  {
    ...
    answer: `All players play on <span class="font-medium">the same server instance</span>.
  ...
  },
  {
    ...
    answer: `Generally speaking, it <span class="font-medium">should not influence your game experience</span>.
  ...
  },
  {
    ...
    answer: `The server of "Albion West" is located in <span class="font-medium">Washington DC, USA</span>. This server location was chosen in such a way that
  ...
  },
  {
    ...
    answer: `As explained in the previous answers, there is <span class="font-medium">no european or australian/oceanic server for Albion Online yet</span>.
...
<template>
  <FaqTwoColumn :content="content">
    <template #heading>
      <Heading> All about the Albion Online server location </Heading>
    </template>
    <template #intro>
      <p class="pt-8">
        <span class="italic">Most people</span> are asking themselves where the Albion Online
        servers are located and if they are the cause for possible lag spikes, rubberbanding or
        other bad online experiences. Also it isn't clear to many Albion players how many server
        instances or shards are actually available and how to switch between them. <br /><br />
